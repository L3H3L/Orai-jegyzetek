...
|                           | Terület<br>millió km$^2$ | Népesség<br>millió fő | Népsűrűség<br>fő/km$^2$ |
| :-----------------------: | :----------------------: | :-------------------: | :---------------------: |
|          Afrika           |           30,5           |         1186          |           39            |
|          Amerika          |            42            |          992          |           24            |
...
- **Legsűrűbben lakott országok**
	- Banglades ($\frac{1000 fő}{km^2}$)
	- India ($\frac{400 fő}{km^2}$)
	- Dél-Korea ()
	- Japán ($\frac{500fő}{km^2}$)
- **Legritkábban lakott országok**
	- Mongólia ($\frac{1,5}{km^2}$)
	- Nepál ($\frac{200}{km^2}$)
	- Ausztrália ($\frac{4 fő}{km^2}$)